    ...
    <template v-if="!adminLoading && isAdminOrGerente">
      ...
      <div class="grid grid-cols-2 xl:grid-cols-4 gap-3 sm:gap-4 mb-6">
        ...
        <div class="relative overflow-hidden rounded-2xl bg-white border border-pink-100 p-4 shadow-sm">
          ...
          <p class="relative text-lg sm:text-2xl font-black truncate" style="color: var(--color-card-texto, #1e293b)">{{ resumoLoading ? '...' : formatCurrency(faturamentoMes) }}</p>
        ...
        <div class="relative overflow-hidden rounded-2xl bg-white border border-pink-100 p-4 shadow-sm">
          ...
          <p class="relative text-2xl font-black" style="color: var(--color-card-texto, #1e293b)">{{ resumoLoading ? '...' : vendasCount }}</p>
        ...
        <div class="relative overflow-hidden rounded-2xl bg-white border border-pink-100 p-4 shadow-sm">
          ...
          <p class="relative text-lg sm:text-xl font-black truncate" style="color: var(--color-card-texto, #1e293b)">{{ resumoLoading ? '...' : formatCurrency(valorContasPagar) }}</p>
        ...
        <div class="relative overflow-hidden rounded-2xl bg-white border border-pink-100 p-4 shadow-sm">
          ...
          <p class="relative text-2xl font-black flex items-center gap-2" style="color: var(--color-card-texto, #1e293b)">
      ...
      <div class="grid grid-cols-2 xl:grid-cols-4 gap-3 sm:gap-4 mb-8">
        ...
        <div class="relative overflow-hidden rounded-2xl bg-white border border-pink-100 p-4 shadow-sm">
          ...
          <p class="relative text-lg sm:text-2xl font-black truncate" style="color: var(--color-card-texto, #1e293b)">{{ resumoLoading ? '...' : formatCurrency(ticketMedio) }}</p>
        ...
        <div class="relative overflow-hidden rounded-2xl bg-white border border-pink-100 p-4 shadow-sm">
          ...
          <p class="relative text-2xl font-black" style="color: var(--color-card-texto, #1e293b)">{{ resumoLoading ? '...' : veiculosDisponiveis }}</p>
        ...
        <div class="relative overflow-hidden rounded-2xl bg-white border border-pink-100 p-4 shadow-sm">
          ...
          <p class="relative text-2xl font-black" style="color: var(--color-card-texto, #1e293b)">{{ resumoLoading ? '...' : tarefasHoje }}</p>
        ...
        <div class="relative overflow-hidden rounded-2xl bg-white border border-pink-100 p-4 shadow-sm">
          ...
          <p class="relative text-2xl font-black" style="color: var(--color-card-texto, #1e293b)">{{ resumoLoading ? '...' : totalClientes }}</p>
