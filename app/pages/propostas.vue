          ...
          <div class="flex items-center gap-3 sm:gap-5">
            ...
            <div>
              <div class="flex items-center gap-2 mb-1">
                <span class="text-xs font-semibold text-amber-400 uppercase tracking-widest">Comercial</span>
        ...
        >
          <div class="bg-white rounded-3xl shadow-2xl w-full max-w-lg overflow-hidden">
            <div class="flex items-center justify-between px-8 py-6 border-b border-gray-100 bg-gradient-to-r from-gray-950 to-gray-900">
              ...
              <button type="button" class="w-8 h-8 flex items-center justify-center rounded-xl text-gray-400 hover:text-white hover:bg-white/10" @click="fecharModal">
            ...
            <form class="flex flex-col gap-5 px-8 py-7 overflow-y-auto max-h-[70vh]" @submit.prevent="adicionando ? salvarAdicao() : salvarEdicao()">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div class="flex flex-col gap-1.5">
                  ...
                  <select v-model="form.status" class="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm bg-gray-50/50 focus:outline-none focus:ring-2 focus:ring-amber-500">
                ...
                <div class="flex flex-col gap-1.5">
                  ...
                  <input v-model="form.data_proposta" type="date" class="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm bg-gray-50/50 focus:outline-none focus:ring-2 focus:ring-amber-500" />
                </div>
              </div>
              <div class="flex flex-col gap-1.5">
                <label class="text-sm font-semibold text-gray-700">Observações</label>
                <textarea v-model="form.observacao" rows="3" placeholder="Condições, entrada, financiamento..." class="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm placeholder:text-gray-400 bg-gray-50/50 focus:outline-none focus:ring-2 focus:ring-amber-500 resize-none" />
              </div>
